...
params.l = 0.225;
params.K = 2.980; %mulitplies with omega^2
params.b = 1.14;
params.Ax = 0.25*0;
params.Ay = 0.25*0;
params.Az = 0.25*0;

% manually set the angular velocity of each motor
omega = 1.075; %1.075
speed = omega*sqrt(1/params.K);
dspeed = 0.05*speed;

% to roll about the x axis (without a position controller)
params.omega1 = speed;
...
% function from the course code to solve the ode approximation
...
% the following functions are the A and B representations of the euler-lagrange equations of motion
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
